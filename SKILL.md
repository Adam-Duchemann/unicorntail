...
name: unicorntail
description: >
  EVAL FIXTURE ONLY — intentionally disabled. The unicorntail code-shape
  ladder ships as the "Code shape: the ladder (all projects)" section of
